...
func insertSetting() {
	...
	settings := []model.Setting{
		...
		{Name: "limit", Value: "20"},
		{Name: "tag", Value: "Go Bbs 是一个基于 Beego 开发的可切换模板的 BBS 社交博客系统。它安装简单便捷，页面简介优美。前端是HTML+JS+CSS，不需要掌握一些前端技术栈也能轻松自定义页面。"},
		{Name: "image", Value: "/static/img/logo.jpg"},
		{Name: "keyword", Value: "Go社区系统,Go开源社区系统,go-bbs,Go,bbs,Go社区,bbsgo"},
		{Name: "description", Value: "Go Bbs 是一个基于 Beego 开发的可切换模板的 BBS 社交博客系统。它安装简单便捷，页面简介优美。前端是HTML+JS+CSS，不需要掌握一些前端技术栈也能轻松自定义页面。"},
