...
// 	loc, _ := time.LoadLocation("Local")
// 	t, _ := time.ParseInLocation("2006-01-02 00:00:00", timeStr, loc)

// 	h5, _ := time.ParseDuration("5h")
// 	//h8, _ := time.ParseDuration("8h")
// 	h12, _ := time.ParseDuration("12h")
// 	h17, _ := time.ParseDuration("17h")
// 	h20, _ := time.ParseDuration("20h")
